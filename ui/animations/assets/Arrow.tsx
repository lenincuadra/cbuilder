...
/**
 * Fill/stroke set for the whole arrow. `fill` covers the fletching and the
 * arrowhead's main triangle; `fillLight`/`fillDark` are the arrowhead's two
 * facets (top highlight, bottom shadow); `shaftFill` is the connecting shaft;
 * `line` is the shared outline stroke for every part. Defaults to the
 * original hand-picked orange/brown scheme — see `ArrowToTarget.tsx` for the
 * gray "unpainted" and per-ring "landed" palettes used there.
 */
export type ArrowPalette = {
  fill: string;
  fillLight: string;
  fillDark: string;
  shaftFill: string;
...
export const DEFAULT_ARROW_PALETTE: ArrowPalette = {
  fill: "#EE8B2A",
  fillLight: "#F49D4C",
  fillDark: "#FB660A",
  shaftFill: "#8E6442",
...
export function Arrow({
  palette = DEFAULT_ARROW_PALETTE,
  ...props
}: SVGProps<SVGSVGElement> & { palette?: ArrowPalette }) {
  return (
    <svg viewBox="0 0 160 56" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M124.2 15.45L147.8 28.25L125.9 19.25L127 25.65" fill={palette.fillLight} />
      <path d="M122.9 40.65L127.8 28.25L125.9 19.25L147.8 28.35L122.9 40.65Z" fill={palette.fillDark} />
      <path
        d="M125.8 26.15H19.1C18.3 26.35 17.3 28.25 18.6 29.75L19.4 30.25H125.9L126.7 28.35L125.8 26.15Z"
        fill={palette.shaftFill}
        stroke={palette.line}
        strokeWidth={1.7762}
        strokeMiterlimit={10}
        strokeLinejoin="round"
